  ...
  publications: [
    {
      ...
      media: {
        type: "image",
        src: "images/publications/read.png",
        alt: "READ learned risk-field visualization and trajectory cost evaluation",
        crop: { x: 1410, y: 215, width: 623, height: 250, imageWidth: 2033 },
      },
      links: [{ label: "Paper", url: "https://arxiv.org/abs/2609.12371" }],
      selected: true,
    },
    {
